const text = {
    ...
    history: [{
            ...
            details: [{
                label: '证书',
                content: 'https://dasai.lanqiao.cn/pages/dasai/cert/cert_search.html'
            }, ]
        },
        {
            title: '射手荣耀APP',
            ...
            icon: 'project',
            summary: '一款与国家射击队合作开发的线上真人射击比赛平台，主要服务于射击爱好者。 其中包含有线上举办全国性赛事、 人机对战、 射友发动态、 写文章、 线上商城等功能。 用户通过个人中心完成每日任务获 得积分，可兑换商品、 打赏文章、 以及参与抽奖活动。',
            details: [{
                    label: '技术栈',
                    content: 'Uni-App、Vue、ColorUI、WebSocket、 El-Admin 框架等'
                },
                {
                    label: '下载地址',
                ...
                {
                    label: '主要负责',
                    content: '负责社交模块开发，包括：类朋友圈、动态详情、写动态、写文章、好友列表、个人空间页、海报分享等'
                },
                {
                    label: '项目亮点',
                    content: [
        ...
        },
        {
            ...
            details: [{
                label: '成绩查询',
                content: 'https://cet.neea.edu.cn/html1/folder/22023/595-1.htm'
            }, ]
        },
        {
            title: '老享乐小程序',
            ...
            icon: 'project',
            summary: '一款服务于中老年人兴趣培训和活动交流的小程序以及后台管理平台，其中包含课程和活动的报名、提醒、签到、管理与统计，以及积分商城系统的下单、退款、管理等功能。',
            details: [{
                    label: '技术栈',
        ...
        },
        {
            ...
            date: '2021.08 - 2021.11',
            icon: 'project',
            summary: '灵鹿聘是一款专注于为大学生提供实习、校招机会的招聘网站，包含后台管理、学生端、企业端、空中招聘、微信小程序。',
            details: [{
                    label: '技术栈',
                    content: 'Vue、Uni-App、Webpack、ElementUI、ColorUI、Sass 等'
                },
                {
                    label: '体验途径（PC端）',
